...
def resolve_task_schedule(
    ...
    try:
        task_schedule = get_task_schedule(kwargs["task_uuid"], kwargs["schedule_uuid"])
        return get_task_schedule_type(info, task_schedule)
    except TaskScheduleModel.DoesNotExist:
        return None
